...
const ProfileTab: React.FC<ProfileTabProps> = ({ loading, setLoading }) => {
  ...
  const handleProvinceChange = async (provinceCode: string) => {
    ...
    profileForm.setFieldsValue({ district: undefined, ward: undefined });
  ...
  const handleDistrictChange = async (districtCode: string) => {
    ...
    profileForm.setFieldsValue({ ward: undefined });
      ...
      <Card className="shadow-sm">
        ...
        >
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <Form.Item label="Địa chỉ chi tiết" name="addressDetails">
              <Input.TextArea
                size="large"
              ...
              <div className="bg-blue-50 rounded-lg p-3 mt-4">
                ...
                <p className="text-blue-800">
                  {LocationService.formatFullAddress(
                    profileForm.getFieldValue("addressDetails") ||
                      "[Địa chỉ chi tiết]",
                    selectedWard,
                    selectedDistrict,
                    selectedProvince
