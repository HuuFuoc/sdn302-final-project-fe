...
const ConsultantCard: React.FC<ConsultantCardProps> = ({ consultant, className = "" }) => {
  return (
    <Card
      ...
      <Card.Meta
        title={
          <div className="text-center">
            <h3 className="text-lg font-semibold text-[#20558A] mb-1">{consultant.fullName}</h3>
        ...
        description={
          <div className="space-y-2">
            ...
            <div className="mt-3 flex flex-wrap gap-1">
              <Tag color="blue" className="text-xs">Mỹ thuật thiếu nhi</Tag>
              <Tag color="green" className="text-xs">Đang hoạt động</Tag>
