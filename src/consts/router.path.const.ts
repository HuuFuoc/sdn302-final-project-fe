export const ROUTER_URL = {
  ...
  ADMIN: {
    ...
    STAFF_CONSULTANTS: "/admin/giang-vien",
  ...
  CONSULTANT: {
    ...
    APPOINTMENT_DETAIL: "/instructor/lich-hen-tu-van/:appointmentId",
    CLIENTS: "/instructor/khach-hang",
    CONSULTATIONS: "/instructor/tuyen-dung",
    ASSESSMENTS: "/instructor/danh-gia",
    RESOURCES: "/instructor/tai-lieu",
    REPORTS: "/instructor/bao-cao",
  },
  STAFF: {
    BASE: "/staff",
    ...
    INSTRUCTORS: "/staff/giang-vien",
    REPORTS: "/staff/bao-cao",
    SETTINGS: "/staff/cai-dat",
    PROFILE: "/staff/profile",
    INSTRUCTOR_REQUESTS: "/staff/yeu-cau-giang-vien",
  },
  MANAGER: {
    BASE: "/manager",
    ...
    CONSULTANTS: "/manager/giang-vien",
